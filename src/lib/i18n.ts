...
export interface Translations {
  ...
  pbAchievedIn: string;
  // Storage quota (C2)
  storageQuotaBanner: string;
  storageQuotaWarning: string;
  // Navigation warning (C4)
  unsavedRaceWarning: string;
  // Error boundary (C5)
  errorBoundaryTitle: string;
  errorBoundaryMessage: string;
  errorBoundaryReload: string;
  errorBoundaryClearData: string;
  // Age group filter note (I7)
  athletesWithoutYob: string;
  // PDF footer (I9)
  pdfFooter: string;
  // Partial results (I14)
  partialResultsTitle: string;
  partialResultsSave: string;
  partialResultsDiscard: string;
  partialResultsContinue: string;
  // CSV headers (I3)
  csvAthlete: string;
  csvDiscipline: string;
  csvValue: string;
  csvUnit: string;
  csvDate: string;
  // Close button (M1)
  close: string;
  // Score aria labels (M4)
  scoreIncrement: string;
  scoreDecrement: string;
  // Language aria (M3)
...
const de: Translations = {
  ...
  clearAllDataDesc: 'Dies löscht alle Sessions, Athleten und Ergebnisse unwiderruflich.',
  ...
  howToStep1Desc:
    'Tippe auf «Neue Session» und gib einen Namen und ein Datum ein. Eine Session fasst alle Läufe, Spiele und Ergebnisse eines Anlasses zusammen.',
  howToStep2Title: 'Athleten hinzufügen',
  howToStep2Desc:
    'Füge Athleten mit Name hinzu. Jahrgang, Geschlecht und Foto sind optional, helfen aber bei Ranglisten und Export.',
  howToStep3Title: 'Lauf oder Spiel starten',
  howToStep3Desc:
    'Wähle eine Disziplin, wähle die Athleten aus und starte den Countdown. Bei Spielen (Fussball, Basketball etc.) zähle direkt die Punkte pro Team.',
  howToStep4Title: 'Rangliste & TV-Modus',
  howToStep4Desc:
    'Öffne die Rangliste, um Bestleistungen pro Disziplin zu sehen. Im TV-Modus wird die Rangliste grossformatig für Zuschauer angezeigt.',
  howToStep5Title: 'Ergebnisse exportieren',
  howToStep5Desc:
    'Exportiere die Ergebnisse als PDF oder CSV. Der Export enthält Rang, Name, Altersklasse und Ergebnis pro Disziplin.',
  // 404
  ...
  pbAchievedIn: 'in',
  // Storage quota
  storageQuotaBanner: 'Speicher fast voll — Daten werden möglicherweise nicht gespeichert.',
  storageQuotaWarning: 'Speicher fast voll. Bitte lösche alte Daten oder Fotos.',
  // Navigation warning
  unsavedRaceWarning: 'Ein Rennen läuft — willst du die Seite wirklich verlassen?',
  // Error boundary
  errorBoundaryTitle: 'Etwas ist schiefgelaufen',
  errorBoundaryMessage: 'Ein unerwarteter Fehler ist aufgetreten. Du kannst versuchen, die App neu zu laden.',
  errorBoundaryReload: 'Neu laden',
  errorBoundaryClearData: 'Daten löschen & neu starten',
  // Age group filter
  athletesWithoutYob: '{count} Athleten ohne Jahrgang nicht angezeigt',
  // PDF footer
  pdfFooter: 'Erstellt mit Trackly',
  // Partial results
  partialResultsTitle: 'Laufendes Rennen abbrechen?',
  partialResultsSave: 'Teilergebnisse speichern',
  partialResultsDiscard: 'Lauf verwerfen',
  partialResultsContinue: 'Rennen fortsetzen',
  // CSV headers
  csvAthlete: 'Athlet',
  csvDiscipline: 'Disziplin',
  csvValue: 'Wert',
  csvUnit: 'Einheit',
  csvDate: 'Datum',
  // Close
  close: 'Schliessen',
  // Score aria
  scoreIncrement: 'Punkt hinzufügen',
  scoreDecrement: 'Punkt abziehen',
  // Language aria
  switchToLanguage: 'Sprache wechseln zu {lang}',
  // No export data
...
const en: Translations = {
  ...
  clearAllDataDesc: 'This will permanently delete all sessions, athletes, and results.',
  ...
  howToStep1Desc:
    'Tap "New Session" and enter a name and date. A session groups all heats, games, and results for one event.',
  howToStep2Title: 'Add athletes',
  howToStep2Desc:
    'Add athletes by name. Year of birth, gender, and photo are optional but help with leaderboards and exports.',
  howToStep3Title: 'Start a heat or game',
  howToStep3Desc:
    'Pick a discipline, select the athletes, and start the countdown. For games (football, basketball, etc.) use the score counter to track points per team.',
  howToStep4Title: 'View leaderboard & TV mode',
  howToStep4Desc:
    'Open the leaderboard to see personal bests per discipline. TV mode shows the leaderboard in large format for spectators.',
  ...
  pbAchievedIn: 'in',
  // Storage quota
  storageQuotaBanner: 'Storage almost full — your data may not be saved.',
  storageQuotaWarning: 'Storage almost full. Please delete old data or photos.',
  // Navigation warning
  unsavedRaceWarning: 'A race is in progress — are you sure you want to leave?',
  // Error boundary
  errorBoundaryTitle: 'Something went wrong',
  errorBoundaryMessage: 'An unexpected error occurred. You can try reloading the app.',
  errorBoundaryReload: 'Reload',
  errorBoundaryClearData: 'Clear data & restart',
  // Age group filter
  athletesWithoutYob: '{count} athletes without birth year not shown',
  // PDF footer
  pdfFooter: 'Generated by Trackly',
  // Partial results
  partialResultsTitle: 'Cancel running race?',
  partialResultsSave: 'Save partial results',
  partialResultsDiscard: 'Discard heat',
  partialResultsContinue: 'Continue race',
  // CSV headers
  csvAthlete: 'Athlete',
  csvDiscipline: 'Discipline',
  csvValue: 'Value',
  csvUnit: 'Unit',
  csvDate: 'Date',
  // Close
  close: 'Close',
  // Score aria
  scoreIncrement: 'Add point',
  scoreDecrement: 'Remove point',
  // Language aria
  switchToLanguage: 'Switch language to {lang}',
  // No export data
